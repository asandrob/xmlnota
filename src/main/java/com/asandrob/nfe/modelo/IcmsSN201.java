...
public class IcmsSN201 extends IcmsSNBase {
	...
	private BigDecimal aliquotaCreditoIcmsST;

	@XStreamAlias("vCredICMSSN")
	private BigDecimal valorCreditoIcmsST;
	...
	public BigDecimal getAliquotaCreditoIcmsST() {
		return aliquotaCreditoIcmsST;
	}

	public void setAliquotaCreditoIcmsST(BigDecimal aliquotaCreditoIcmsST) {
		this.aliquotaCreditoIcmsST = aliquotaCreditoIcmsST;
	}

	public BigDecimal getValorCreditoIcmsST() {
		return valorCreditoIcmsST;
	}

	public void setValorCreditoIcmsST(BigDecimal valorCreditoIcmsST) {
		this.valorCreditoIcmsST = valorCreditoIcmsST;
	}
